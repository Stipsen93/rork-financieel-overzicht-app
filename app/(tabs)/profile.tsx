  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        <Text style={styles.sectionTitle}>OpenAI ChatGPT API Instellingen</Text>
        ...
        >
          <Text style={styles.saveButtonText}>OpenAI API Sleutel Opslaan</Text>
        </TouchableOpacity>
          ...
          <View style={styles.statusContainer}>
            ...
            <Text style={styles.statusDescription}>
              {useApi 
                ...
                : 'OpenAI API is uitgeschakeld. Schakel het in via Voorkeuren om de scan functionaliteit te gebruiken.'
              }
            </Text>
          </View>
        )}
      ...
      <View style={styles.section}>
        <Text style={styles.sectionTitle}>API Sleutels Verkrijgen</Text>
        <Text style={styles.description}>
          <Text style={styles.boldText}>OpenAI ChatGPT API:</Text>{'\n'}
